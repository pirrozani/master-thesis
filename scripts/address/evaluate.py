"""Evaluation script for address extraction models."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Evaluate address extraction model on test dataset',
...
Examples:
  ...
  uv run scripts/address/evaluate.py data/processed/test --model qwen-3b --save-predictions
        """,
    )
    parser.add_argument(
        'test_data_path',
        ...
        help='Path to test dataset directory (e.g., data/processed/all/test)',
    )
    parser.add_argument(
        '--model',
        type=str,
        default=DEFAULT_MODEL,
        help=f'Model alias (default: {DEFAULT_MODEL}). Use --list-models to see options.',
    )
    parser.add_argument(
        '--adapter-path',
        type=str,
