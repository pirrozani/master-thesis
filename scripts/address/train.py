"""Training script for address extraction model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Train address extraction model with QLoRA',
...
Examples:
  uv run scripts/address/train.py data/processed/dir 
    ...
    print('Use these weights for inference with AddressExtractor')
    print('=' * 60)
