...
DEFAULT_TEST_DATA = 'data/processed/entity_name/classification_external/test'


def main():
    """Run the evaluation pipeline."""
    parser = argparse.ArgumentParser(
        description='Evaluate external entity type classification model on test set',
...
Examples:
  uv run scripts/entity_name/classification_external/evaluate.py <test_dir>
    --model qwen-0.5b
  uv run scripts/entity_name/classification_external/evaluate.py <test_dir>
    --save-predictions
        """,
